...
String _$counterHash() => r'd9c4eca34edc49059577d5399eb7c43585e9d83f';
...
class CounterProvider extends AutoDisposeNotifierProviderImpl<Counter, int> {
  ...
  bool operator ==(Object other) {
    return other is CounterProvider && other.initVal == initVal;
  }
...
mixin CounterRef on AutoDisposeNotifierProviderRef<int> {
  /// The parameter `initVal` of this provider.
  int get initVal;
}
...
class _CounterProviderElement
  ...
  @override
  int get initVal => (origin as CounterProvider).initVal;
}
